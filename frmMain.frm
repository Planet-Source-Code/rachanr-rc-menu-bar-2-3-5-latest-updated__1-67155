...
If UCase$(LocalLang) = "THAI" Then
    If cboMonth.Text = "มกราคม" Then nMonth = 1
    If cboMonth.Text = "กุมภาพันธ์" Then nMonth = 2
    If cboMonth.Text = "มีนาคม" Then nMonth = 3
    If cboMonth.Text = "เมษายน" Then nMonth = 4
    If cboMonth.Text = "พฤษภาคม" Then nMonth = 5
    If cboMonth.Text = "มิถุนายน" Then nMonth = 6
    If cboMonth.Text = "กรกฎาคม" Then nMonth = 7
    If cboMonth.Text = "สิงหาคม" Then nMonth = 8
    If cboMonth.Text = "กันยายน" Then nMonth = 9
    If cboMonth.Text = "ตุลาคม" Then nMonth = 10
    If cboMonth.Text = "พฤศจิกายน" Then nMonth = 11
    If cboMonth.Text = "ธันวาคม" Then nMonth = 12
Else
...
If UCase$(lLang) = "THAI" Then
    cboMonth.AddItem "มกราคม"           '1
    cboMonth.AddItem "กุมภาพันธ์"       '2
    cboMonth.AddItem "มีนาคม"           '3
    cboMonth.AddItem "เมษายน"           '4
    cboMonth.AddItem "พฤษภาคม"          '5
    cboMonth.AddItem "มิถุนายน"         '6
    cboMonth.AddItem "กรกฎาคม"          '7
    cboMonth.AddItem "สิงหาคม"          '8
    cboMonth.AddItem "กันยายน"          '9
    cboMonth.AddItem "ตุลาคม"           '10
    cboMonth.AddItem "พฤศจิกายน"        '11
    cboMonth.AddItem "ธันวาคม"          '12
    For i = 0 To 9
    ...
    Select Case dMonth
    Case Is = 1
        cboMonth.Text = "มกราคม"
        cboMonth.toolTipText = "มกราคม"
        nMonth = 1
    Case Is = 2
        cboMonth.Text = "กุมภาพันธ์"
        cboMonth.toolTipText = "กุมภาพันธ์"
        nMonth = 2
    Case Is = 3
        cboMonth.Text = "มีนาคม"
        cboMonth.toolTipText = "มีนาคม"
        nMonth = 3
    Case Is = 4
        cboMonth.Text = "เมษายน"
        cboMonth.toolTipText = "เมษายน"
        nMonth = 4
    Case Is = 5
        cboMonth.Text = "พฤษภาคม"
        cboMonth.toolTipText = "พฤษภาคม"
        nMonth = 5
    Case Is = 6
        cboMonth.Text = "มิถุนายน"
        cboMonth.toolTipText = "มิถุนายน"
        nMonth = 6
    Case Is = 7
        cboMonth.Text = "กรกฎาคม"
        cboMonth.toolTipText = "กรกฎาคม"
        nMonth = 7
    Case Is = 8
        cboMonth.Text = "สิงหาคม"
        cboMonth.toolTipText = "สิงหาคม"
        nMonth = 8
    Case Is = 9
        cboMonth.Text = "กันยายน"
        cboMonth.toolTipText = "กันยายน"
        nMonth = 9
    Case Is = 10
        cboMonth.Text = "ตุลาคม"
        cboMonth.toolTipText = "ตุลาคม"
        nMonth = 10
    Case Is = 11
        cboMonth.Text = "พฤศจิกายน"
        cboMonth.toolTipText = "พฤศจิกายน"
        nMonth = 11
    Case Is = 12
        cboMonth.Text = "ธันวาคม"
        cboMonth.toolTipText = "ธันวาคม"
        nMonth = 12
    End Select
Else
