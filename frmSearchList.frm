...
Case Is = "THAI"
    Select Case iMonth
    Case Is = 1: GetMonth = "มกราคม"    '1
    Case Is = 2: GetMonth = "กุมภาพันธ์"       '2
    Case Is = 3: GetMonth = "มีนาคม"           '3
    Case Is = 4: GetMonth = "เมษายน"           '4
    Case Is = 5: GetMonth = "พฤษภาคม"          '5
    Case Is = 6: GetMonth = "มิถุนายน"         '6
    Case Is = 7: GetMonth = "กรกฎาคม"          '7
    Case Is = 8: GetMonth = "สิงหาคม"          '8
    Case Is = 9: GetMonth = "กันยายน"          '9
    Case Is = 10: GetMonth = "ตุลาคม"           '10
    Case Is = 11: GetMonth = "พฤศจิกายน"        '11
    Case Is = 12: GetMonth = "ธันวาคม"          '12
    End Select
Case Else
    Select Case iMonth
